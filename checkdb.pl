...
if ($mode eq "ticker_hilden") {
	...
	#} else {
		$pokemon_ids="3,6,9,24,26,28,31,34,36,38,40,45,51,53,55,57,59,62,65,68,71,76,78,80,82,83,85,87,89,91,94,95,101,103,106,107,108,110,112,113,114,115,123,125,127,128,130,131,132,134,135,136,137,139,141,142,143,144,145,146,148,149,150,151";
	#}
