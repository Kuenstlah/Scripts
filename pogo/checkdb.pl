...
if ($mode eq "ticker_h") {
	...
	#} else {
		$pkm_ids="3,6,9,26,28,31,34,36,38,45,51,57,59,62,65,68,71,76,78,80,82,83,85,89,94,101,103,105,106,107,110,112,113,114,115,128,130,131,132,134,135,136,139,141,142,143,144,145,146,149,150,151";
	#}
